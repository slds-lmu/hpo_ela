...
learner$train(task)
pdf("plots/classify_type_rp.pdf", width = 8, height = 4)
...
pdf("plots/classify_dim_bbob_rp.pdf", width = 8, height = 4)
...
#pdf("plots/classify_best_bbob_rp.pdf", width = 8, height = 4)
#rpart.plot(learner$model, roundint = FALSE, box.palette = 0, tweak = 1.2)
#dev.off()
...
#learner$train(task_bbob_best)
#pdf("plots/classify_gensa_other_bbob_rp.pdf", width = 8, height = 4, units = "in", res = 150)
#rpart.plot(learner$model, roundint = FALSE, box.palette = 0, tweak = 1/2)
#dev.off()
